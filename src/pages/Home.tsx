                ...
                <section className="py-20 bg-green-700 text-white">
                    <div className="container mx-auto px-4 text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link to="/contact">
                                <button
                                    className="inline-flex items-center justify-center rounded-md bg-white px-6 py-3 text-green-700 hover:bg-gray-100 transition-colors">
                                    Связаться с нами
                                </button>
                            </Link>
                            <button onClick={openCallback}
                                    className="inline-flex items-center justify-center rounded-md border border-white px-6 py-3 text-white hover:bg-green-800 transition-colors">
                                Заказать звонок
                            </button>
                        </div>
                    </div>
