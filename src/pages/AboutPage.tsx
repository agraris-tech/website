        ...
        <>
            ...
            <div>
                ...
                <section className="relative overflow-hidden bg-white py-16 md:py-24">
                    ...
                    {/* Decorative Elements */}
                    <div
                        className="absolute top-0 right-0 w-96 h-96 bg-green-100 rounded-full blur-3xl opacity-30 -translate-y-1/2 translate-x-1/2"></div>
                    <div
                        className="absolute bottom-0 left-0 w-96 h-96 bg-yellow-100 rounded-full blur-3xl opacity-30 translate-y-1/2 -translate-x-1/2"></div>
                    ...
                    <div className="container mx-auto px-4">
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                            {companyInfo.map((info, index) => {
                                ...
                                return (
                                    <div key={index}
                                         className="bg-gradient-to-br from-gray-50 to-green-50 p-6 rounded-xl border border-gray-200 hover:shadow-lg transition-shadow">
                                        <div
                        ...
                        <div className="grid md:grid-cols-2 gap-12">
                            <div className="bg-green-50 p-8 rounded-2xl border-2 border-green-200">
                                ...
                                <p className="text-lg text-gray-600">
                                    Обеспечивать сельскохозяйственные предприятия Беларуси, России и Казахстана
                                    качественной европейской
                                    техникой, способствуя развитию современного и эффективного аграрного сектора. Мы
                                    стремимся быть надежным
                                    партнером, предлагая не только технику, но и комплексную поддержку на всех этапах
                                    сотрудничества.
                                </p>
                            </div>
                            <div className="bg-gray-50 p-8 rounded-2xl border-2 border-gray-300">
                                ...
                                <p className="text-lg text-gray-600">
                                    Стать ведущим поставщиком европейской сельскохозяйственной техники в Беларуси,
                                    России и Казахстане,
                                    признанным за высочайшие стандарты обслуживания, прозрачность в бизнесе и
                                    долгосрочные партнерские
                                    отношения. Мы верим в индивидуальный подход к каждому клиенту и профессиональную
                                    экспертизу.
                                </p>
                            </div>
                        </div>
                            ...
                            {[
                                ...
                                <div key={index} className="flex gap-6 items-start group">
                                    <div className="flex-shrink-0">
                                        <div
                                            className="w-20 h-20 bg-green-700 rounded-full flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform">
                                            {milestone.year}
                                        </div>
                                    </div>
