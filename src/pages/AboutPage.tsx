          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-gray-50 p-8 rounded-2xl border-2 border-gray-300">
              ...
              <p className="text-lg text-gray-600">
                ...
                признанным за высочайшие стандарты обслуживания, прозрачность в бизнесе и долгосрочные 
                партнерские отношения. Мы верим в индивидуальный подход к каждому клиенту и 
